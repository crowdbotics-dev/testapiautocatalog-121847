...
## Project Structure
    ...
    ├── testapiautocatalog_121847  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_121847`
...
2. Clone this repo and `cd testapiautocatalog_121847`
